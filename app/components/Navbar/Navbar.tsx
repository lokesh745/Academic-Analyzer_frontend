...
export default function Navbar({}: Props) {
  ...
  return (
    <div className="border-b-2 fixed w-full z-10  border-gray-700">
      <nav className="text-white h-[70px] bg-[#212529] flex justify-between backdrop-filter backdrop-blur-sm   ">
        <div className="flex lg:gap-x-28">
          ...
          <div className="lg:flex w-[700px] lg:justify-between lg:items-center hidden   ">
            <div className="hover:cursor-pointer hover:text-blue-400">Dashboard</div>
            <div className="hover:cursor-pointer hover:text-blue-400">User</div>
            <div className="hover:cursor-pointer hover:text-blue-400">Courses</div>
            <div className="hover:cursor-pointer hover:text-blue-400">Department</div>
          </div>
        </div>
        <div className="w-[130px]  lg:w-[130px]  flex items-center lg:justify-around hover:cursor-pointer justify-around mx-5 ">
          ...
          <Link href="/">
            <div className=" hidden lg:flex  hover:text-blue-400">Logout</div>
          </Link>
          {hamburgerState ? (
            <div
              className="lg:hidden ml-3 hover:text-blue-400"
      ...
      >
        <div className="hover:cursor-pointer hover:text-blue-400 border  border-gray-700 py-3 w-full flex justify-center text-white">
          Dashboard
        </div>
        <div className="hover:cursor-pointer hover:text-blue-400 border  border-gray-700 py-3 w-full flex justify-center text-white">
          Employee
